...
object FilterParams {
    val query = mutableListOf(
        ...
        DataPointCategory("Gtb_Dr", mutableListOf("^.*gtbank.*\$"), mutableListOf("^.* dr.*\$"),DataPointType.SMS),
        DataPointCategory("Gtb_Cr", mutableListOf("^.*gtbank.*\$"), mutableListOf("^. cr.*\$"),DataPointType.SMS),
