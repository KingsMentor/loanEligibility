...
object FilterParams {
    val query = mutableListOf(
        ...
        DataPointCategory("Gtb_Airtime", mutableListOf("^.*gtbank.*\$"), mutableListOf("^.*airtel.*\$"),DataPointType.SMS),
        DataPointCategory("Gtb_Dr", mutableListOf("^.*gtbank.*\$"), mutableListOf("^.*transfer to.*\$"),DataPointType.SMS),
        DataPointCategory("Gtb_Cr", mutableListOf("^.*gtbank.*\$"), mutableListOf("^.*amt:.*\$"),DataPointType.SMS),
